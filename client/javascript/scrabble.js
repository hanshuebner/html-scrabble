...
Tile.prototype.toString = function () {
  return (
    "Tile: [" + (this.isBlank() ? "blank" : this.letter) + "] --> " + this.score
  );
};
    ...
    for (var x = 0; x < this.Dimension; x++) {
      ...
      if (this.Dimension == 15) {
        if (
          ...
          (x > 0 &&
            x < middle - 2 &&
            (y == x || y == this.Dimension - x - 1)) ||
          (x > middle + 2 &&
            x < this.Dimension - 1 &&
            (x == y || x == this.Dimension - y - 1))
        ) {
          ...
          ((y == 0 || y == this.Dimension - 1 || y == middle) &&
        ...
        if (
          (x == 0 && y == 0) ||
          (x == this.Dimension - 1 && y == this.Dimension - 1) ||
          ...
          (x == 2 && y == 5) ||
          (y == 2 && x == 5) ||
          (x == this.Dimension - 1 - 5 && y == 2) ||
          (y == this.Dimension - 1 - 5 && x == 2) ||
          (x == 5 && y == this.Dimension - 1 - 2) ||
          (y == this.Dimension - 1 - 2 && x == 5) ||
          (x == this.Dimension - 1 - 2 && y == this.Dimension - 1 - 5) ||
          (y == this.Dimension - 1 - 2 && x == this.Dimension - 1 - 5)
        ) {
          square = new Square("QuadLetter", this);
        } else if (
          ((x == 3 || x == middle || x == this.Dimension - 1 - 3) &&
            (y == 3 ||
              (y == middle && x != middle) ||
              y == this.Dimension - 1 - 3)) || // original 8 3xW
          (x == 0 && (y == middle - 3 || y == middle + 3)) ||
          (x == this.Dimension - 1 && (y == middle + 3 || y == middle - 3)) ||
          (y == 0 && (x == middle - 3 || x == middle + 3)) ||
          (y == this.Dimension - 1 && (x == middle + 3 || x == middle - 3))
        ) {
          square = new Square("TripleWord", this);
        } else if (
          (x == middle && y == middle) || // board middle
          (x >= 0 &&
            x < middle - 2 &&
            (y == x || y == this.Dimension - x - 1)) || // one main diagonal
          (x > middle + 2 &&
            x <= this.Dimension - 1 &&
            (x == y || x == this.Dimension - y - 1)) || // other main diagonal
          ...
          ((y < 3 || y > middle) && x == this.Dimension - y - 1 - 7)
        ) {
          // left start: right to left minor diagonal
          square = new Square("DoubleWord", this);
          if (x == middle && y == middle) {
            centerStart = true;
          }
          ...
          ((x == middle - 1 || x == middle + 1) &&
            (y == middle - 1 || y == middle + 1)) || // one-off from board middle
          (x == 0 && y == 3) ||
          (y == 0 && x == 3) || // row and column 0
          (x == 0 && y == middle) ||
          (y == 0 && x == middle) ||
          (x == 0 && y == this.Dimension - 1 - 3) ||
          (y == 0 && x == this.Dimension - 1 - 3) ||
          (x == this.Dimension - 1 && y == 3) ||
          (y == this.Dimension - 1 && x == 3) || // row and column 20
          (x == this.Dimension - 1 && y == middle) ||
          (y == this.Dimension - 1 && x == middle) ||
          (x == this.Dimension - 1 && y == this.Dimension - 1 - 3) ||
          (y == this.Dimension - 1 && x == this.Dimension - 1 - 3) ||
          (x == 3 && y == middle - 4) ||
          (y == 3 && x == middle - 4) || // row and column 3
          (x == 3 && y == middle + 4) ||
          (y == 3 && x == middle + 4) ||
          (x == this.Dimension - 1 - 3 && y == middle - 4) ||
          (y == this.Dimension - 1 - 3 && x == middle - 4) || // row and column 17
          (x == this.Dimension - 1 - 3 && y == middle + 4) ||
          (y == this.Dimension - 1 - 3 && x == middle + 4) ||
          (x == 5 && y == middle - 1) ||
          (y == 5 && x == middle - 1) || // row and column 5
          (x == 5 && y == middle + 1) ||
          (y == 5 && x == middle + 1) ||
          (x == this.Dimension - 1 - 5 && y == middle - 1) ||
          (y == this.Dimension - 1 - 5 && x == middle - 1) || // row and column 15
          (x == this.Dimension - 1 - 5 && y == middle + 1) ||
          (y == this.Dimension - 1 - 5 && x == middle + 1) ||
          (x == 6 && y == middle) ||
          (y == 6 && x == middle) || // row and column 6
          (x == this.Dimension - 1 - 6 && y == middle) ||
          (y == this.Dimension - 1 - 6 && x == middle)
        ) {
          square = new Square("DoubleLetter", this);
        } else if (
          ((x == middle - 2 || x == middle + 2) &&
            (y == middle - 2 || y == middle + 2)) || // 2 squares off board middle
          (x == 1 && y == 4) ||
          (y == 1 && x == 4) || // row+col 1
          (x == 1 && y == this.Dimension - 1 - 4) ||
          (y == 1 && x == this.Dimension - 1 - 4) ||
          (x == this.Dimension - 1 - 1 && y == 4) ||
          (y == this.Dimension - 1 - 1 && x == 4) || // row+col 19
          (x == this.Dimension - 1 - 1 && y == this.Dimension - 1 - 4) ||
          (y == this.Dimension - 1 - 1 && x == this.Dimension - 1 - 4) ||
          (x == 4 && y == middle - 2) ||
          (y == 4 && x == middle - 2) || // row+col 4
          (x == 4 && y == middle + 2) ||
          (y == 4 && x == middle + 2) ||
          (x == this.Dimension - 1 - 4 && y == middle - 2) ||
          (y == this.Dimension - 1 - 4 && x == middle - 2) || // row+col 16
          (x == this.Dimension - 1 - 4 && y == middle + 2) ||
          (y == this.Dimension - 1 - 4 && x == middle + 2)
        ) {
          square = new Square("TripleLetter", this);
        }
      }
...
Rack.prototype.findLetterSquare = function (letter, includingBlank) {
  ...
  var square = _.find(this.squares, function (square) {
    if (square.tile) {
...
function calculateMove(squares) {
  ...
  function touchingOld(x, y) {
    var retval =
      ...
      (x < boardLen - 1 &&
        squares[x + 1][y].tile &&
        squares[x + 1][y].tileLocked) ||
      (y > 0 && squares[x][y - 1].tile && squares[x][y - 1].tileLocked) ||
      (y < boardLen - 1 &&
        squares[x][y + 1].tile &&
        squares[x][y + 1].tileLocked);
    return retval;
  }
