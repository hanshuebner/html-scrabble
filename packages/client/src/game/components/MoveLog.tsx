  ...
  return (
    <div className="bg-[#F7F7E3] border border-[#DCDCC6] rounded-md p-3">
      ...
      <div ref={scrollRef} className="h-40 overflow-auto text-xs space-y-1">
        {turns.length === 0 && <div className="text-[#AAA38E] italic">No moves yet</div>}
        {turns.map((turn, i) => {
          ...
          return (
            <div key={i} className="border-b border-[#DCDCC6] pb-1">
              <div className="flex justify-between">
                ...
                {turn.type === 'pass' && <span className="text-[#AAA38E]">passed</span>}
                {turn.type === 'swap' && <span className="text-blue-600">swapped {turn.count}</span>}
